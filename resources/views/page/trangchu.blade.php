@extends('master')
@section('content')
<div  class ="row" style="color: red;font-size: 20px;">@if(Session::has('thongbao')){{Session::get('thongbao')}}@endif</div>
@if(Session::has('flag'))
    ...
    <div class="col-sm-12">
        <div class="beta-products-list">
            ...
            <div class="beta-products-details">
                <p class="pull-left">Tim thay {{ count(array('new_product'))}}san pham</p>
        ...
        <div class="beta-products-list">
            ...
            <div class="beta-products-details">
                <p class="pull-left">{{ count(array('sanpham_khuyenmai'))}}San pham</p>
                <div class="clearfix"></div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="single-item">
                        <div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
                        <div class="single-item-header">
                            <a href="product.html"><img style="width: 250px;height:250px;" src="source/image/product/{{ $spkm->image }}" alt=""></a>
                        </div>
                        <div class="single-item-body">
