                ...
                <div class="col-sm-9">
                    <div class="beta-products-list">
                        ...
                        <div class="beta-products-details">
                            <p class="pull-left">Tim thay {{ count(array('sp_theoloai'))}}san pham</p>
                            <div class="clearfix"></div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img style="width: 250px;height:250px;" src="source/image/product/{{ $sp_theoloai->image }}" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{ $sp_theoloai->name }}</p>
                                        <p class="single-item-price">
                                            <span class="flash-del">{{ $sp_theoloai->unit_price }} dong</span>
                                            <span class="flash-sale">{{ $sp_theoloai->promotion_price }} dong</span>
                                        </p>
                                    </div>
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="{{ route('themgiohang',$sp_theoloai->id) }}"><i class="fa fa-shopping-cart"></i></a>
                                        <a class="beta-btn primary" href="{{ route('chitietsanpham',$sp_theoloai->id) }}">Details <i class="fa fa-chevron-right"></i></a>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="beta-products-details">
                            <p class="pull-left">Tim thay {{ count(array('sp_khac')) }} san pham</p>
                            <div class="clearfix"></div>
                        </div>
                        <div class="row">
                        @foreach($sp_khac as $sp_khac)
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img style="width: 250px; height:250px;" src="source/image/product/{{ $sp_khac->image }}" alt=""></a>
                                    </div>
