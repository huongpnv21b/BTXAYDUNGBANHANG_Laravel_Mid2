							...
							<div class="beta-sales beta-lists">
								<div class="media beta-sales-item">
									...
									<div class="media-body">
										...
										<span class="beta-sales-price">{{ number_format($spbc->unit_price) }} dong</span>
									</div>
								</div>
							</div>
                        </div>
					...
					<div class="widget">
						...
						<div class="widget-body">
							...
							<div class="beta-sales beta-lists">
								...
								<div class="media beta-sales-item">
									<a class="pull-left" href="{{ route('chitietsanpham',$spn->id) }}"><img src="source/image/product/{{ $spn->image }}" alt=""></a>
									<div class="media-body">
                                        <p class="single-item-title">{{ $spn->name }}</p>
										<span class="beta-sales-price">{{ number_format($spn->unit_price) }} dong</span>
									</div>
								</div>
